        ...
        <div class="container-fluid">
            ...
            <div class="card mb-3">
                <div class="card-header">
                    <i class="fas fa-plus"></i> Add New Budget Items</div>
                <div class="card-body">
            ...
            ?>
                                        <option value="<?php echo $row->names;?>">&nbsp;&nbsp; &nbsp; &nbsp;
                                            <?php echo $row->names;?> &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</option>
                                        <?php } ?>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="col-lm-16">
                                <select name="account" id="costcenters" class="form-control" required>
                                    ...
                                    <?php $query ="SELECT * FROM budget_line";
                                        ...
                                        {
                                        ?>
                                        <option value="<?php echo $row->AccountCode;?>">
                                            <?php echo $row->AccountCode;?>&nbsp;&nbsp; &nbsp; &nbsp;&emsp; &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</option>
                                        <?php } ?>
                                </select>
                            </div>
                        </div>
            ...
            {
            ?>
                                        <option value="<?php echo $row->AccountName;?>">
                                            <?php echo $row->AccountName;?>&nbsp;&nbsp; &nbsp; &nbsp; &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</option>
                                        <?php } ?>
                                </select>
                            </div>
                        </div>
...
<div class="card-footer small text-muted">Develop By Bukeye Timothy </div>            </div>
